    ...
    <div className="min-h-screen  bg-yellow-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-4xl w-full bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 p-10 flex flex-col justify-between">
          <div>
            <h1 className="text-4xl font-extrabold mb-4">Gizzard & Liver</h1>
            <p className="text-xl text-gray-700 mb-4">₹180/kg</p>

            <p className="text-gray-600 mb-6 leading-relaxed">
              Our Gizzard & Liver is freshly cut, hygienic, and ready for your 
